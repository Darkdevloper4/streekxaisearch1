        ...
        <div className="flex-1 overflow-y-auto p-4 pb-12">
            ...
            <SecurityCard title="How you sign in to StreekX">
                 ...
                 <SecurityRow 
                    ...
                    onClick={() => {
                        if (!twoFactor) {
                            const backupId = prompt("Enter another StreekX ID for 2-step authentication:");
                            if (backupId) {
                                alert(`OTP has been sent to ${backupId} notifications.`);
                                const otp = prompt("Enter the OTP sent to " + backupId + ":");
                                if (otp) {
                                    setTwoFactor(true);
                                    alert("2-Step Verification is now ON.");
                                }
                            }
                        } else {
