        ...
        <div className="flex-1 overflow-y-auto p-4 pb-12">
            ...
            <SecurityCard title="How you sign in to StreekX">
                 ...
                 <SecurityRow 
                    ...
                    subtitle={<span className="bg-yellow-500/10 text-yellow-500 px-2 py-0.5 rounded text-xs font-bold flex items-center gap-1 w-fit mt-1"><svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clipRule="evenodd"></path></svg> Add an email address</span>}
                    onClick={() => {}}
                    isLast
                 />
